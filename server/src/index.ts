...
import {
	Event, EventUpdateReturn,
	EventPreview,
	FormDetails,
	Organisation,
	OrganisationPreview, OrganisationUpdateReturn, UserRoles, UserRolesUpdateReturn, UserUpdateReturn, User,
} from "./interface";
...
const app = new Elysia()
	...
	.delete('/admin/orgs/:orgId/members', () => {
		return {
			statusCode: 200,
